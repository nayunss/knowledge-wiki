...
| readability-reviewer 최종 가독성 게이트 | 약 45k | 1–2분 |
| 오케스트레이션(인벤토리·병합·게이트·발행) | 10–25k | 3–5분 (배포 포함) |
| **소계 (수정 루프 없이)** | **약 210–300k** | **약 12–32분** |
...
- 요약: **하네스 1편 ≈ 375–425k 토큰, 20–40분** (위 두 예시는 최종 가독성 게이트 도입 전 수치라 각각 +약 45k). 단순 업로드의 **약 30–80배 토큰**.
