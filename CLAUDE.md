...
| 2026-08-03 | 도메인 전문성 게이트 추가: 본문 전 `00_domain_brief.md`, 권위 출처 2개 이상 기반 표준/피할 용어, fact-checker 개념 경계 검증, 전문 문체 4축 최종 검수 | tech-writer·tech-writing·fact-checker·wiki-verify·copy-editor·readability-review·wiki-post·README·위키-하네스 | 전문가 페르소나만으로는 비표준 직역·자의적 조어·홍보성 문체를 막기 어려움. 전문성을 용어 계약→검증→최종 문체 판정으로 실행 가능하게 만듦 |
